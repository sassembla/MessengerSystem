...
メッセンジャーの削除をビューに反映する \hypertarget{interface_messenger_view_controller_acfc602cab1e37653e205cc03bf909095}{
\index{MessengerViewController@{MessengerViewController}!drawCallLineFrom:withMID:to:withMID:@{drawCallLineFrom:withMID:to:withMID:}}
\index{drawCallLineFrom:withMID:to:withMID:@{drawCallLineFrom:withMID:to:withMID:}!MessengerViewController@{MessengerViewController}}
\subsubsection[{drawCallLineFrom:withMID:to:withMID:}]{\setlength{\rightskip}{0pt plus 5cm}-\/ (void) drawCallLineFrom: 
\begin{DoxyParamCaption}
\item[{dummy(NSString $\ast$)}]{ senderName}
\item[{withMID:(NSString $\ast$)}]{ senderMID}
\item[{to:(NSString $\ast$)}]{ addressName}
\item[{withMID:(NSString $\ast$)}]{ addressMID}
\end{DoxyParamCaption}
}}
\label{d7/d34/interface_messenger_view_controller_acfc602cab1e37653e205cc03bf909095}
発生した通信に対して、同調するインスタンスを表示する

通信の発生を確認し、表示するメソッド \hypertarget{interface_messenger_view_controller_aba89f37600bb5cc7258a034614257dc6}{
...
View用の辞書を取得する \hypertarget{interface_messenger_view_controller_aa76c05b79b38d78ee26b4fb8be95d6eb}{
\index{MessengerViewController@{MessengerViewController}!getScreenWidth@{getScreenWidth}}
\index{getScreenWidth@{getScreenWidth}!MessengerViewController@{MessengerViewController}}
\subsubsection[{getScreenWidth}]{\setlength{\rightskip}{0pt plus 5cm}-\/ (float) getScreenWidth 
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
}}
\label{d7/d34/interface_messenger_view_controller_aa76c05b79b38d78ee26b4fb8be95d6eb}
スクリーンサイズの取得

スクリーン情報取得 \hypertarget{interface_messenger_view_controller_a2c2f7a46b94facbc66d66c7dd6da34bd}{
...
メッセンジャーの誕生をビューに反映する \hypertarget{interface_messenger_view_controller_a9a0f05d1d3a3685a3d3ce7632c2bc7ee}{
